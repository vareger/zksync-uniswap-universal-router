...
export async function deployUniswapV2(
  ...
  const uniswapV2Factory = (await deployer.deploy(UniswapV2Factory_ZkSyncArtifact, [ALICE_ADDRESS])) as unknown as UniswapV2Factory
  const uniswapRouterV2 = (await deployer.deploy(UniswapV2Router02_ZkSyncArtifact, [uniswapV2Factory.address, wethAddress])) as unknown as UniswapV2Router02
