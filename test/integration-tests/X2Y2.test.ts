...
import { ALICE_ADDRESS, ALICE_PRIVATE_KEY, DEADLINE, ZERO_ADDRESS } from './shared/constants'
...
describe('X2Y2', () => {
  ...
  describe('ERC-721 purchase', () => {
    ...
    beforeEach(async () => {
      ...
      router = (await deployUniversalRouter(permit2, ZERO_ADDRESS, ZERO_ADDRESS, ZERO_ADDRESS, x2y2.address)).connect(
        alice
      ) as UniversalRouter
