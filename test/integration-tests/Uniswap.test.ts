...
import {deployUniswapV2, UniswapV2Factory, UniswapV2Router02} from './shared/deployUniswapV2'
...
describe('Uniswap V2 and V3 Tests:', () => {
    ...
    before(async () => {
        ...
        wethContract = <IWETH9> await deployer.deploy(WETH9 as any as ZkSyncArtifact, [])
        console.log(4);
