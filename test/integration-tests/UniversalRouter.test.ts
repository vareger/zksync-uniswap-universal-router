...
import { ALICE_PRIVATE_KEY, OPENSEA_CONDUIT_KEY, ZERO_ADDRESS } from './shared/constants'
...
describe('UniversalRouter', () => {
  ...
  before(async () => {
    ...
    mockLooksRareRewardsDistributor = await deployer.deploy(MockLooksRareRewardsDistributor, [
      ROUTER_REWARDS_DISTRIBUTOR,
      mockLooksRareToken.address,
    ])
    mockLooksRareRewardsDistributor = new Contract(
      mockLooksRareRewardsDistributor.address,
      MockLooksRareRewardsDistributor.abi,
      alice
    )
